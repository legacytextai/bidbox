-- Data-only backfill for Opportunity Intelligence projects.
-- Repairs source candidate links and fills project county from source metadata
-- where it can be resolved deterministically. No schema changes.
