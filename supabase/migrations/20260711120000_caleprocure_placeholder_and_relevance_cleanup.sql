...
--   * Existing Caltrans duplicate markers are preserved.
--   * Placeholder titles are rejected regardless of public-works allowlist terms.
...
filtered AS (
  ...
  WHERE reason IS NOT NULL
    -- Strong public works/construction signals keep borderline rows visible.
