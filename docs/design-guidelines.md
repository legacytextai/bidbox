...
| Purpose              | Hex       | RGB             |  
|----------------------|-----------|------------------|  
| \*\*Primary\*\* (black)  | \`\#121212\` | \`18, 18, 18\`     |  
| \*\*Accent Red\*\*       | \`\#D92D20\` | \`217, 45, 32\`    |  
| \*\*Soft Gray\*\*        | \`\#F4F4F5\` | \`244, 244, 245\`  |  
| \*\*Outline\*\*          | \`\#E4E4E7\` | \`228, 228, 231\`  |  
| \*\*Link Blue\*\*        | \`\#1D4ED8\` | \`29, 78, 216\`    |  
| \*\*Success Green\*\*    | \`\#12B76A\` | \`18, 183, 106\`   |
...
🔤 Typographic Scale Element	Size	Weight H1	28px	Bold H2	22px	Semibold H3 / Labels	16px	Medium Body	14px	Regular Caption	12px	Light 📐 Spacing System
...
BidBox strikes the right tone for high-stakes bid workflows. Visuals are clear, form fields are scannable, and the experience reduces decision fatigue. Every button serves a clear purpose. One improvement: consider a dark-mode variant for late-night GC usage.  
