          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4 animate-slide-in-left">
              ...
              <div className="space-y-3">
                {["No logins required — subs just click the link and submit", "SMS + Email invites with auto-reminders before the deadline", "Track who viewed the plans and who ghosted you", "Clean dashboard + one-click Excel export for bid day", "Priced for small GCs: starts at $49/month, no contracts"].map((benefit, idx) => <div key={idx} className="flex items-start gap-3">
