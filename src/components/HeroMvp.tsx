        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4 animate-slide-in-left">
              ...
              <p className="text-xl leading-relaxed text-foreground">Save time on bid day. <span className="font-semibold">Send one link and watch the quotes roll in.</span></p>
              </div>

              {/* Key Benefits */}
              <div className="space-y-3">
                {["Share plans & get quotes with one link", "No logins for subs — they actually respond", "All quotes in one clean dashboard", "Faster coverage for every trade", "Set up a bid room in under 2 minutes"].map((benefit, idx) => <div key={idx} className="flex items-start gap-3">
