        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4 animate-slide-in-left">
              ...
              <p className="text-xl leading-relaxed"><span className="text-muted-foreground">Stop chasing subcontractors. Stop wrestling with overbuilt software.</span> <span className="text-foreground">Just upload your plans, send one link, and watch the quotes roll in.</span></p>
              </div>
