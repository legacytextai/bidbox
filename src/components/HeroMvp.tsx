        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4 animate-slide-in-left">
              ...
              <p className="text-xl leading-relaxed text-muted-foreground">Stop chasing subcontractors. Stop wrestling with overbuilt software.</p>
              <p className="text-xl leading-relaxed text-foreground font-semibold">Just upload your plans, send one link, and watch the quotes roll in.</p>
              </div>
